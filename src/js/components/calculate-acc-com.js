const amountRange = document.querySelector('.calculate-acc-com__amount-line');
const termRange = document.querySelector('.calculate-acc-com__term-line');
const refillRange = document.querySelector('.calculate-acc-com__refill-line');

const totalCount = document.querySelector('#calculate-acc-com-result-count')
const totalIncome = document.querySelector('#calculate-acc-com-result-income')
const totalIPercent = document.querySelector('#calculate-acc-com-result-perc')

const ctx = document.getElementById('calculate-acc-com-chart')
...
if(amountRange){
    const nodes = [document.querySelector('.calculate-acc-com__amount-count')];
...
if(termRange){
    const nodes = [document.querySelector('.calculate-acc-com__term-count')];
...
if(refillRange){
  const nodes = [document.querySelector('.calculate-acc-com__refill-count').querySelector('b')];
